...
{
    public partial class ModificarUsuarioAdminn : System.Web.UI.Page
    {
...
//        }
        ...
        protected void btnDatos_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    usuario = new csUsuario(int.Parse(Request.Params["perfil"]), txtNombre1.Text, txtNombre2.Text, txtApe1.Text, txtApe2.Text, txtCorreo.Text, "", txtDir.Text, txtFechaNac.Text, txtTelefono.Text, int.Parse(txtNumDoc.Text), int.Parse(dtTpDoc.SelectedValue.ToString()), int.Parse(dtCiudad.SelectedValue.ToString()), "");
        ...
        protected void btnGuardarPass_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (lgUsuario.CambiarPass(util.Encriptar(txtPass1.Text), int.Parse(Request.Params["perfil"])))
                {
                    lgUsuario = new LogicaUsuario();
