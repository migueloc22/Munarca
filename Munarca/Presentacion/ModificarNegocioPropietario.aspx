                ...
                <div class="panel-body">
                    <div class="form-horizontal">
                        <div class="form-group">
                            ...
                            <asp:Label ID="lbId_negocio" runat="server" Text="Label" Visible="False"></asp:Label>
                        ...
                        <div class="form-group">
                            <asp:Button ID="btnModificarNegocio" runat="server" Text="Modificar" CssClass="btn btn-danger" OnClick="btnModificarNegocio_Click"  />
                        </div>
