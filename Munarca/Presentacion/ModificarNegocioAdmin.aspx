<%@ Page Title="" Language="C#" MasterPageFile="~/UsusarioAdminn.master" AutoEventWireup="true" CodeBehind="ModificarNegocioAdmin.aspx.cs" Inherits="Presentacion.ModificarNegocioAdmin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="panel-primary">
                    <div class="panel-body">
                        ...
                        <div class="btn-group">
                            ...
                            <asp:HyperLink ID="hpRegresar1" CssClass="bnt btn-default" runat="server">Regresar</asp:HyperLink>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <asp:Panel ID="pnModal" runat="server" Style="display: none; background-color: white; width: auto; height: auto;">
        ...
        <div class="modal-footer">
            <asp:HyperLink ID="hpRegresar2" runat="server" CssClass="btn btn-danger" >Regresar a Negocio</asp:HyperLink>
        </div>
